...
/// "unable to lease content: lease does not exist" even when Testcontainers can still use the image.
/// </summary>
internal static class DockerImagePullHelper
{
    ...
    private static void WritePullWarning(string imageReference, int? exitCode, string detail)
    {
        ...
        Console.Error.WriteLine(
            $"[JobScheduler.DAL.DynamoDb.Tests] Optional docker pull for '{imageReference}' did not succeed"
